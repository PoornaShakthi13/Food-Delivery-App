            ...
            <View className='absolute left-0 right-0 bottom-0 bg-white'>
                <View>
                    ...
                    <View className='flex-row justify-between px-5 pt-4'>
                        ...
                        <Text className='text-gray-500'>Rs. {JSON.stringify(groupedItems) === '{}' ? '0.00' : 300}</Text>
                    </View>
                    <View className='flex-row justify-between px-5 pt-4'>
                        <Text className='font-bold'>order Total</Text>
                        <Text className='font-bold'>Rs. {(subtotal + (JSON.stringify(groupedItems) === '{}' ? 0 : 300)).toFixed(2)}</Text>
                    </View>
                </View>
